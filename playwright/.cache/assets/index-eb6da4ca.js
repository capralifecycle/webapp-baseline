import { r as reactExports, R as React, a as ReactDOM } from './index-ed91c96d.js';
...
function createStaticHandler(routes, opts) {
  ...
  async function submit(request, matches, actionMatch, requestContext, isRouteRequest) {
    ...
    return _extends$2({}, context, result.statusCode ? {
...
function useNavigateUnstable() {
  ...
  let navigate = reactExports.useCallback(function (to, options) {
    ...
    "production" !== "production" ? warning(activeRef.current, navigateEffectWarning) : void 0;
...
function useRoutesImpl(routes, locationArg, dataRouterState) {
  ...
  if ("production" !== "production") {
    ...
    "production" !== "production" ? warning(matches == null || matches[matches.length - 1].route.element !== undefined || matches[matches.length - 1].route.Component !== undefined, "Matched leaf route at location \"" + location.pathname + location.search + location.hash + "\" " + "does not have an element or Component. This means it will render an <Outlet /> with a " + "null value by default resulting in an \"empty\" page.") : void 0;
  }
...
function _renderMatches(matches, parentMatches, dataRouterState) {
  ...
  if (errors != null) {
    ...
    !(errorIndex >= 0) ? "production" !== "production" ? invariant(false, "Could not find a matching route for errors on route IDs: " + Object.keys(errors).join(",")) : invariant(false) : void 0;
...
function useDataRouterContext$1(hookName) {
  ...
  !ctx ? "production" !== "production" ? invariant(false, getDataRouterConsoleError$1(hookName)) : invariant(false) : void 0;
  return ctx;
}
function useDataRouterState$1(hookName) {
  let state = reactExports.useContext(DataRouterStateContext);
  !state ? "production" !== "production" ? invariant(false, getDataRouterConsoleError$1(hookName)) : invariant(false) : void 0;
  return state;
}
function useRouteContext(hookName) {
  let route = reactExports.useContext(RouteContext);
  !route ? "production" !== "production" ? invariant(false, getDataRouterConsoleError$1(hookName)) : invariant(false) : void 0;
  return route;
}
...
function useCurrentRouteId(hookName) {
  ...
  !thisRoute.route.id ? "production" !== "production" ? invariant(false, hookName + " can only be used on routes that contain a unique \"id\"") : invariant(false) : void 0;
...
function RouterProvider$1(_ref) {
  ...
  return /*#__PURE__*/reactExports.createElement(reactExports.Fragment, null, /*#__PURE__*/reactExports.createElement(DataRouterContext.Provider, {
    ...
    navigator: navigator
  }, state.initialized ? /*#__PURE__*/reactExports.createElement(DataRoutes$1, {
...
function Navigate(_ref4) {
  ...
  "production" !== "production" ? warning(!reactExports.useContext(NavigationContext).static, "<Navigate> must not be used on the initial render in a <StaticRouter>. " + "This is a no-op, but you should modify your code so the <Navigate> is " + "only ever rendered in response to some user interaction or state change.") : void 0;
  let {
    matches
  } = reactExports.useContext(RouteContext);
  let {
...
function Router(_ref5) {
  ...
  "production" !== "production" ? warning(locationContext != null, "<Router basename=\"" + basename + "\"> is not able to match the URL " + ("\"" + pathname + search + hash + "\" because it does not start with the ") + "basename, so the <Router> won't render anything.") : void 0;
...
function createRoutesFromChildren(children, parentPath) {
  ...
  reactExports.Children.forEach(children, (element, index) => {
    ...
    !(!element.props.index || !element.props.children) ? "production" !== "production" ? invariant(false, "An index route cannot have child routes.") : invariant(false) : void 0;
    let route = {
...
function mapRouteProperties(route) {
  ...
  if (route.Component) {
    if ("production" !== "production") {
      if (route.element) {
        "production" !== "production" ? warning(false, "You should not include both `Component` and `element` on your route - " + "`Component` will be used.") : void 0;
      }
    }
  ...
  if (route.ErrorBoundary) {
    if ("production" !== "production") {
      if (route.errorElement) {
        "production" !== "production" ? warning(false, "You should not include both `ErrorBoundary` and `errorElement` on your route - " + "`ErrorBoundary` will be used.") : void 0;
      }
    }
    Object.assign(updates, {
...
function getFormEncType(encType) {
  if (encType != null && !supportedFormEncTypes.has(encType)) {
    "production" !== "production" ? warning(false, "\"" + encType + "\" is not a valid `encType` for `<Form>`/`<fetcher.Form>` " + ("and will default to \"" + defaultEncType + "\"")) : void 0;
    return null;
  }
  return encType;
}
...
const FetchersContext = /*#__PURE__*/reactExports.createContext(new Map());
if ("production" !== "production") {
...
function RouterProvider(_ref) {
  ...
  let fetcherData = reactExports.useRef(new Map());
  let {
    v7_startTransition
  } = future || {};
  ...
  if (typeof to === "string" && ABSOLUTE_URL_REGEX.test(to)) {
    ...
    if (isBrowser) {
      try {
        ...
        "production" !== "production" ? warning(false, "<Link to=\"" + to + "\"> contains an invalid URL which will probably break " + "when clicked - please update to a valid URL path.") : void 0;
      }
    }
  }
...
function useDataRouterContext(hookName) {
  let ctx = reactExports.useContext(DataRouterContext);
  !ctx ? "production" !== "production" ? invariant(false, getDataRouterConsoleError(hookName)) : invariant(false) : void 0;
  return ctx;
}
function useDataRouterState(hookName) {
  let state = reactExports.useContext(DataRouterStateContext);
  !state ? "production" !== "production" ? invariant(false, getDataRouterConsoleError(hookName)) : invariant(false) : void 0;
  return state;
}
// External hooks
/**
...
function useFormAction(action, _temp2) {
  ...
  !routeContext ? "production" !== "production" ? invariant(false, "useFormAction must be used inside a RouteContext") : invariant(false) : void 0;
...
function useFetcher(_temp3) {
  ...
  !fetcherData ? "production" !== "production" ? invariant(false, "useFetcher must be used inside a FetchersContext") : invariant(false) : void 0;
  !route ? "production" !== "production" ? invariant(false, "useFetcher must be used inside a RouteContext") : invariant(false) : void 0;
  !(routeId != null) ? "production" !== "production" ? invariant(false, "useFetcher can only be used on routes that contain a unique \"id\"") : invariant(false) : void 0;
  // Fetcher key handling
  let [fetcherKey, setFetcherKey] = reactExports.useState(key || "");
  ...
  let load = reactExports.useCallback((href, opts) => {
    !routeId ? "production" !== "production" ? invariant(false, "No routeId available for fetcher.load()") : invariant(false) : void 0;
  ...
  let FetcherForm = reactExports.useMemo(() => {
    let FetcherForm = /*#__PURE__*/reactExports.forwardRef((props, ref) => {
...
function useScrollRestoration(_temp4) {
  ...
  usePageHide(reactExports.useCallback(() => {
    ...
    try {
      ...
      "production" !== "production" ? warning(false, "Failed to save scroll positions in sessionStorage, <ScrollRestoration /> will not work properly (" + error + ").") : void 0;
    }
    window.history.scrollRestoration = "auto";
...
function useViewTransitionState(to, opts) {
  ...
  !(vtContext != null) ? "production" !== "production" ? invariant(false, "`unstable_useViewTransitionState` must be used within `react-router-dom`'s `RouterProvider`.  " + "Did you accidentally import `RouterProvider` from `react-router`?") : invariant(false) : void 0;
  let {
    basename
...
//# sourceMappingURL=index-eb6da4ca.js.map
